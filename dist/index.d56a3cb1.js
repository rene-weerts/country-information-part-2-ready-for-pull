...
async function fetchCountryInformation() {
    ...
    try {
        ...
        const response = await _axiosDefault.default.get(BASE_URI + ENDPOINT);
        ...
        const countryByName = response.data.find((oneCountry)=>{
            return oneCountry.name === document.getElementById("search");
        });
    // console.log(countryByName)
    //- We maken een ordered list waarbij de data in de html wordt geinjecteerd en in de juiste volgorde op de pagina komt
    //- We gebruiken de back-ticks en de volgende elementen image-flag/country-name/
